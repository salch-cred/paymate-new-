...
const features = [
  ...
  { icon: "shield" as const, n: "03", title: "Build portable trust", text: "Every verified settlement strengthens your ERC-8004 reputation on Metis Sepolia." },
]
...
export default function Home() {
  ...
  return (
    <main className="site-shell" id="top" onPointerMove={movePage}>
      ...
      <div className="top-note"><span className="pulse-dot"/>Payments now settling on Metis Sepolia <a href="#workflow">See the live flow <Icon name="arrow" size={14}/></a></div>
      <nav className="nav-wrap glass" aria-label="Main navigation">
        ...
        <div className="nav-actions"><span className="network-live"><i/>METIS LIVE</span><Link href="/dashboard" className="button button-dark nav-cta">Open workspace <Icon name="arrow" size={17}/></Link></div>
      ...
      <section className="hero section-pad">
        ...
        <div className="hero-copy">
          ...
          </div><div className="hero-live-row"><span><i/>LIVE ON METIS</span><span>USDC SETTLEMENT</span><span>ERC—8004 PROOF</span></div>
        ...
        <div className="hero-visual" aria-label="PayMate invoice product preview" onPointerMove={movePreview} onPointerLeave={resetPreview}>
          ...
          <div className="preview-window glass-heavy">
            ...
            <div className="preview-body">
              ...
              <div className="invoice-preview">
                ...
                <div className="invoice-amount"><span>Amount due</span><strong>$2,480.00</strong><em>USDC · Metis Sepolia</em></div>
          ...
          <div className="chain-orbit"><i/><i/><i/><span>METIS</span></div><div className="compose-chip glass"><Icon name="spark" size={15}/><span><b>Intelligent draft ready</b><small>Scope · amount · terms</small></span><i/></div>
        </div><a className="scroll-cue" href="#product"><span>SCROLL TO EXPLORE</span><i/></a>
      </section>

      <section className="proof-strip"><div className="proof-track"><span>POWERING TRUSTED WORK ON</span><b>METIS</b><b>ERC—8004</b><b>x402</b><b>USDC</b><span>DIRECT SETTLEMENT</span><b>PORTABLE TRUST</b></div></section>
      ...
      <section className="signal-rail section-pad" aria-label="PayMate platform capabilities">
        ...
        <article><span>02</span><Icon name="bolt"/><div><b>x402 settlement</b><small>Verified on Metis</small></div></article>
      ...
      <section className="protocol-showcase section-pad">
        ...
        <div className="protocol-console glass-heavy"><div className="console-bar"><span><i/><i/><i/></span><b>LIVE SETTLEMENT TRACE</b><small>METIS · 12,841,092</small></div><div className="trace-row active"><span>01</span><Icon name="invoice"/><div><b>Invoice created</b><small>PM-2948 · 2,480.00 USDC</small></div><em>00:00.00</em></div><div className="trace-line"><i/></div><div className="trace-row"><span>02</span><Icon name="wallet"/><div><b>Transfer submitted</b><small>0x8f2a…e19c</small></div><em>00:04.28</em></div><div className="trace-line"><i/></div><div className="trace-row verified"><span>03</span><Icon name="shield"/><div><b>Settlement verified</b><small>Token · recipient · amount</small></div><em>FINAL</em></div><div className="console-proof"><span>PROOF</span><code>0x71E4 · 2480000000 · 0x8f2a</code><Icon name="check"/></div></div>
      </section>
      ...
      <footer className="site-footer">
        ...
        <div className="footer-main">
          ...
          <div className="footer-links"><div><span>PRODUCT</span><a href="#product">Smart invoices</a><a href="#workflow">Settlement flow</a><a href="#security">Portable trust</a></div><div><span>NETWORK</span><a href="https://www.metis.io" target="_blank" rel="noreferrer">Metis</a><a href="#security">ERC-8004</a><a href="#security">x402 protocol</a></div><div><span>START</span><Link href="/dashboard">Open workspace</Link><Link href="/docs">Documentation</Link><a href="mailto:hello@paymate.work">Contact</a></div></div>
        </div>
        <div className="footer-orbit"><span>PAYMATE</span><div><i/> SETTLEMENT ONLINE</div></div>
        <div className="footer-bottom"><span>© 2026 PayMate · Work, settled.</span><div className="footer-badges"><span><Icon name="lock" size={12}/>Non-custodial</span><span><Icon name="network" size={12}/>Metis Sepolia</span><span><Icon name="shield" size={12}/>ERC-8004</span></div><div><a href="#">Privacy</a><a href="#">Terms</a><a href="#top">Back to top ↑</a></div></div>
      </footer>
    </main>
  )
}
