    ...
    <main className="site-shell" id="top" onPointerMove={movePage}>
      ...
      <nav className="nav-wrap glass" aria-label="Main navigation">
        ...
        <div className={`nav-links ${menu ? "open" : ""}`}>
          <a href="#product"><span>01</span>Product</a><a href="#workflow"><span>02</span>Workflow</a><a href="#security"><span>03</span>Security</a><Link href="/docs"><span>04</span>Docs</Link><Link href="/dashboard/marketplace"><span>05</span>Marketplace</Link>
  ...
  https://paymateagent.xyz/openclaw-skill.json</code></pre>
      ...
      <footer className="site-footer">
        ...
        <div className="footer-main">
          ...
          <div className="footer-links"><div><span>PRODUCT</span><a href="#product">Smart invoices</a><a href="#workflow">Settlement flow</a><a href="#security">Portable trust</a></div><div><span>NETWORK</span><a href="https://www.goat.network" target="_blank" rel="noreferrer">GOAT Network</a><a href="#security">ERC-8004</a><a href="#security">x402 protocol</a></div><div><span>START</span><Link href="/dashboard">Open workspace</Link><Link href="/docs">Documentation</Link><Link href="/dashboard/marketplace">Plugin marketplace</Link><a href="mailto:hello@paymateagent.xyz">Contact</a><a href="mailto:hello@catwallet.io">Partner: CatWallet</a></div></div>
        </div>
